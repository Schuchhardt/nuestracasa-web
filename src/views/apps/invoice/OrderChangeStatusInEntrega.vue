...
const onSubmit = () => {
  let description = 'Chofer confirmó que ya llego al punto de entrega'
  emit('submit',{
    step: 5,
    description,
          ...
          <VForm @submit.prevent="onSubmit">
            <VRow>
              <VCol cols="12">
                <VCheckbox
                  v-model="checkboxOne"
                  label="Confirmo llegada al punto de entrega"
                />
              </VCol>
              ...
              <VCol cols="12" >
                <VBtn :disabled="!checkboxOne || isUploadingFiles"
                  ...
                  class="me-3"
                >
                  {{ isUploadingFiles ? 'Cargando...' : 'Siguiente: En punto de entrega' }}
                </VBtn>
              </VCol>
            </VRow>
          </VForm>
