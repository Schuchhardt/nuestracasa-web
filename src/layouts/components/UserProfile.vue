...
const userProfileList = [
  { type: 'navItem', icon: 'mdi-account-outline', title: 'Perfil', to: { name: 'apps-user-view-id', params: { id: 21 } } },
  ...
  { type: 'divider' },
  { type: 'navItem', icon: 'mdi-lifebuoy', title: 'Ayuda', to: { name: 'pages-help-center' } },
  ...
  { type: 'divider' },
  { type: 'navItem', icon: 'mdi-logout', title: 'Salir', onClick: logout },
]
      ...
      >
        <VList density="comfortable">
          ...
          <VListItem height="60px">
            ...
            <VListItemSubtitle>{{ userData.role == 'admin' ? 'Chofer' : 'Cliente' }}</VListItemSubtitle>
          </VListItem>
